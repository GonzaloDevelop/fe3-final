...
const Card = ({ user, onClick }) => {
    ...
    return (
        <div className="relative flex flex-col items-center justify-center min-h-[25vh] gap-2 lg:w-full bg-oyster-pink-100 border border-red-500 rounded-lg p-4 shadow-md dark:bg-purple-900 dark:hover:bg-purple-700 hover:bg-gray-200 dark:border-green-200 dark:text-white sm:max-w-sm xs:max-w-xs">
            <div className='absolute -top-8 w-full flex justify-center' >
                <img src={DoctorIcon} alt="Doctor" className="w-16 h-16 md:w-20 md:h-20 cursor-pointer rounded-full border-2 border-red-500 dark:border-green-600" onClick={onClick} />
            </div>
