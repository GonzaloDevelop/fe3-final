    ...
    <nav>
      <ul className='hidden lg:flex mx-auto max-w-4xl items-center justify-between gap-x-4 lg:px-8 px-4 sm:gap-0'>
        <li className='list-none cursor-pointer'>
          <Link to='/' className='dark:text-white text-2xl'>Home</Link>
        </li>
        <li className='list-none cursor-pointer'>
          <Link to='/contact' className='dark:text-white text-2xl'>Contacto</Link>
        </li>
        <li className='list-none cursor-pointer'>
          <Link to='/favs' className='dark:text-white text-2xl'>Favoritos</Link>
        </li>
